define(["chroma-js", "virtual-dom", "numeral-intl", "filters/genericnode" ],
  ...
  return function (config, filterManager) {
    ...
    self.setData = function (data) {
      ...
      var meshDict = count(onlineNodes, ["meshlinks"], function (d) {
        return d ? d : 0
      })

      var uplinkDict = count(onlineNodes, ["vpnlinks"], function (d) {
        return d && d > 0 ? "ja" : "nein"
      })
      ...
      fillTable("#Mesh Links", meshTable, meshDict.sort(function (a, b) { return b[1] - a[1] }))
